...
const Section = styled.section`
  ...
  background: ${({ solid, solidbg, bg, flip }) =>
    solid
      ? solidbg
      : bg
      ? `conic-gradient(from ${
          flip ? "-163.65deg" : "163.65deg"
        } at 50% 50%, ${bg} 0deg, white 390deg)`
      : ""};

  @media all and(min-width: 50em) {
    flex-direction: ${({ bisect, reverse }) =>
      reverse ? "row-reverse" : bisect ? "row" : "column"};
    align-items: center;
  }
`;
