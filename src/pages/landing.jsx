        ...
        <Fade direction="down">
          <Section solid solidbg="black">
            <ImageCard hero source={herobg} button>
              <Button href="/upload" textColor="white">
                Get Started
              </Button>
            </ImageCard>
            <TextContainer overlay>
              ...
              <BodyText color="cyan" overlay>
                Lorem ipsum dolor sit amet I am the glob glob glooo bob bob
                abananan its the and of in time out gin when your feel like
                dream now flus or night
              </BodyText>
            </TextContainer>
          </Section>
        </Fade>
